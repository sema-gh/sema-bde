...
export default async function (docs, { dateRange, group }, { graphs }) {
  ...
  const maxMinutes = moment.duration(1, group).asMinutes()

  for (dataItem of dataProvider) {
    Object.keys(dataItem).forEach(e => {
      if (e === 'timestamp') return
      dataItem[e] = Math.round(dataItem[e] / maxMinutes * 10000) / 100
    })
  }
